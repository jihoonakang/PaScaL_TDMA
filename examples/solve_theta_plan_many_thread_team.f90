...
!$omp parallel do default(shared) &
        private(i, ip, im, j, jp, jm, jep, jem, k, kp, km) &
        private(dedx1, dedx2, dedy3, dedy4, dedz5, dedz6) &
        private(viscous_e1, viscous_e2, viscous_e3, viscous) &
        private(ebc_down, ebc_up, ebc) &
        private(eAPI, eAMI, eACI, eAPJ, eAMJ, eACJ, eAPK, eAMK, eACK, eRHS)
    do k = 1, nz_sub-1
        kp = k+1
        km = k-1
